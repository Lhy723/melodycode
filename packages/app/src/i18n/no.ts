...
export const dict = {
  ...
  "dialog.provider.MelodyCode.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.MelodyCode.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.MelodyCodeGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av MelodyCode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i MelodyCode.",
  ...
  "provider.connect.MelodyCodeZen.line1":
    "MelodyCode Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.MelodyCodeZen.visit.prefix": "Besøk ",
  "provider.connect.MelodyCodeZen.visit.link": "MelodyCode.ai/zen",
  "provider.connect.MelodyCodeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i MelodyCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i MelodyCode.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i MelodyCode.json",
  ...
  "dialog.server.description": "Bytt hvilken MelodyCode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av MelodyCode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til MelodyCode-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (MelodyCode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at MelodyCode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "MelodyCode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør MelodyCode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for MelodyCode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan MelodyCode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om MelodyCode skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan MelodyCode er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når MelodyCode starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av MelodyCode.",
