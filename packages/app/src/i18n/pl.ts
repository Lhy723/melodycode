export const dict = {
  ...
  "dialog.provider.MelodyCode.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.MelodyCode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.MelodyCodeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez MelodyCode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w MelodyCode.",
  ...
  "provider.connect.MelodyCodeZen.line1":
    "MelodyCode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.MelodyCodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.MelodyCodeZen.visit.link": "MelodyCode.ai/zen",
  "provider.connect.MelodyCodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w MelodyCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w MelodyCode.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w MelodyCode.json",
  ...
  "dialog.server.description": "Przełącz serwer MelodyCode, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja MelodyCode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu MelodyCode",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (MelodyCode.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "MelodyCode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla MelodyCode",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd MelodyCode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy MelodyCode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw MelodyCode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania MelodyCode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji MelodyCode.",
