export const dict = {
  ...
  "dialog.provider.MelodyCode.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.MelodyCode.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.MelodyCodeGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje MelodyCode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u MelodyCode-u.",
  ...
  "provider.connect.MelodyCodeZen.line1":
    "MelodyCode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.MelodyCodeZen.visit.prefix": "Posjeti ",
  "provider.connect.MelodyCodeZen.visit.link": "MelodyCode.ai/zen",
  "provider.connect.MelodyCodeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u MelodyCode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u MelodyCode-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u MelodyCode.json",
  ...
  "dialog.server.description": "Promijeni na koji se MelodyCode server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija MelodyCode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku MelodyCode timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (MelodyCode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: MelodyCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "MelodyCode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni MelodyCode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u MelodyCode-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako MelodyCode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li MelodyCode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu MelodyCode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se MelodyCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju MelodyCode-a.",
