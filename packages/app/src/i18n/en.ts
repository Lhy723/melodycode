export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by MelodyCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in MelodyCode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "MelodyCode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in MelodyCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in MelodyCode.",
  ...
  "dialog.server.description": "Switch which MelodyCode server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "MelodyCode",
  ...
  "wsl.onboarding.checkingOpencode": "Checking MelodyCode...",
  "wsl.onboarding.checkingOpencodeIn": "Checking MelodyCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating MelodyCode...",
  "wsl.onboarding.updatingOpencodeIn": "Updating MelodyCode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update MelodyCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update MelodyCode",
  "wsl.onboarding.opencodeReadyIn": "MelodyCode is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "MelodyCode is ready.",
  "wsl.onboarding.installOpencodeIn": "Install MelodyCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install MelodyCode",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen MelodyCode.",
  ...
  "toast.update.description": "A new version of MelodyCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the MelodyCode team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, MelodyCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "MelodyCode includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the MelodyCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for MelodyCode",
  ...
  "settings.general.row.appearance.description": "Customise how MelodyCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether MelodyCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how MelodyCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when MelodyCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of MelodyCode.",
