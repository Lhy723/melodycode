export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von MelodyCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von MelodyCode wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.cli.installed.message":
    "CLI wurde in {{path}} installiert\n\nStarten Sie Ihr Terminal neu, um den Befehl 'melodycode' zu verwenden.",
